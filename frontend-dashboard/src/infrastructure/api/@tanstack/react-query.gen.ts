 ...
 */
export const getPostsOptions = (options?: Options<GetPostsData>) => queryOptions<GetPostsResponse, DefaultError, GetPostsResponse, ReturnType<typeof getPostsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
