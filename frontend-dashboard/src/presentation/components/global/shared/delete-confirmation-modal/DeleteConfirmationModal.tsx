...
export const DeleteConfirmationModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm animate-in bg-black/50 fade-in duration-200">
      <div className="bg-background p-8 rounded-lg shadow-lg flex flex-col gap-4 min-w-sm max-w-md border border-white/10 animate-in slide-in-from-bottom-4 duration-200">
