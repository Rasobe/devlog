  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-background text-foreground">
      <div className="relative flex flex-col items-center animate-in fade-in duration-500">
        ...
        {/* Brand Text */}
        <h1 className="relative text-5xl font-extrabold tracking-tighter bg-gradient-to-br from-blue-400 to-indigo-600 bg-clip-text text-transparent drop-shadow-lg">
          DevLog
        </h1>
